export const oscalSchema={
  ...
  "definitions": {
    ...
    "Base64Datatype": {
      ...
      "type": "string",
      "$id": "#/definitions/Base64Datatype",
      "pattern": "^[0-9A-Za-z+/]+={0,2}$",
      "contentEncoding": "base64"
    },
    "BooleanDatatype": {
      "$id": "#/definitions/BooleanDatatype",
      "description": "A binary value that is either: true or false.",
      "type": "boolean"
    },
    "DateDatatype": {
      "$id": "#/definitions/DateDatatype",
    ...
    "DateTimeWithTimezoneDatatype": {
      "$id": "#/definitions/DateTimeWithTimezoneDatatype",
    ...
    "EmailAddressDatatype": {
      "$id": "#/definitions/EmailAddressDatatype",
    ...
    "IntegerDatatype": {
      "$id": "#/definitions/IntegerDatatype",
      "description": "A whole number value.",
      "type": "integer"
    },
    "NonNegativeIntegerDatatype": {
      "$id": "#/definitions/NonNegativeIntegerDatatype",
    ...
    "PositiveIntegerDatatype": {
      "$id": "#/definitions/PositiveIntegerDatatype",
